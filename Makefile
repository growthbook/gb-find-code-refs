...
define publish_docker
	...
	docker build -t growthbook/$(3):$(1) build/package/$(4)
	docker push growthbook/$(3):$(1)
	# test $(2) && (echo "Not pushing latest tag for prerelease")
	test $(2) || docker tag growthbook/$(3):$(1) growthbook/$(3):latest
	test $(2) || docker push growthbook/$(3):latest
endef
